  ...
  return (
    <>
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto  md:px-2 md:py-0 2xl:px-0 p-2">
          <Link href="/">
            <img
          ...
          <div className="flex md:order-2">
            ...
            <div className="relative hidden md:flex rounded-md border-[1px] border-gray-300 focus:border-blue-800">
              <div className="flex items-center pointer-events-none pl-[0.85rem]">
              ...
              <input
                type="text"
                id="search-navbar"
                className="border-none focus:all-unset focus:ring-0 bg-transparent "
                placeholder="Search..."
              />
            </div>
